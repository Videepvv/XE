...
#this tokenization part should include getting the vision 3070 paired embeddings as an additional key 
#in the dictionary to ensure everything is tensorized and shuffled consitently. 

#load the vision embeddings here and have a flag for testing vs training



def vision_tokenize(tokenizer, mention_pairs,vision_map, mention_map, m_end, max_sentence_len=1024, text_key='bert_doc', truncate=True):
